...
const ManageOccupantsModal = ({ isOpen, onClose, roomId, onRefresh }) => {
  ...
  const handleRemoveSelected = () => {
    ...
    setConfirmDialog({
      isOpen: true,
      type: 'warning',
      title: 'Release Selected Students?',
      message: `Release ${selected.length} student(s) from this room?`,
      details: [
        'Students will be removed from this room',
        'Their status will be reset to "Pending"',
        'Room occupancy will be updated',
      ],
      confirmLabel: 'Release Students',
      onConfirm: async () => {
        setLoading(true);
        try {
  ...
  const handleClearAll = () => {
    setConfirmDialog({
      isOpen: true,
      type: 'danger',
      title: 'Clear All Room Occupants?',
      message: 'Are you sure you want to remove ALL students from this room?',
      details: [
        '⚠️ This will release all occupants from this room',
        'All assigned students will be reset to "Pending"',
        'The room will become vacant',
      ],
